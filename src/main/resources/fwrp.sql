...
INSERT INTO Subscriptions (consumer_id, city, province, method, status)
VALUES (1, 'Ottawa', 'ON', 'email', TRUE),
       (2, 'Ottawa', 'ON', 'sms', FALSE),
       (3, 'Ottawa', 'ON', 'email', TRUE),
       (4, 'Ottawa', 'ON', 'sms', TRUE),
       (5, 'Ottawa', 'ON', 'email', FALSE),
       (6, 'Ottawa', 'ON', 'sms', TRUE),
       (7, 'Ottawa', 'ON', 'email', TRUE),
       (8, 'Ottawa', 'ON', 'sms', FALSE),
       (9, 'Toronto', 'ON', 'email', TRUE),
       (10, 'Montréal', 'QC', 'sms', FALSE),
       (11, 'Vancouver', 'BC', 'email', TRUE),
       (12, 'Calgary', 'AB', 'sms', TRUE),
       (13, 'Edmonton', 'AB', 'email', FALSE),
       (14, 'Winnipeg', 'MB', 'email', TRUE),
       (15, 'Quebec City', 'QC', 'sms', TRUE),
       (16, 'Hamilton', 'ON', 'email', FALSE),
       (17, 'Mississauga', 'ON', 'sms', TRUE),
       (18, 'Brampton', 'ON', 'email', TRUE),
       (19, 'Surrey', 'BC', 'sms', FALSE),
       (20, 'Kitchener', 'ON', 'email', TRUE),
       (21, 'Halifax', 'NS', 'sms', TRUE),
       (22, 'Laval', 'QC', 'email', FALSE),
       (23, 'London', 'ON', 'sms', TRUE),
       (24, 'Victoria', 'BC', 'email', TRUE);
